...
class PasswordLoginScreen extends StatefulWidget {
  final String email;
  const PasswordLoginScreen({required this.email});
...
class _PasswordLoginScreenState extends State<PasswordLoginScreen>
  ...
  bool _validate() {
    ...
    if (p.length < 8) {
      setState(() => _passwordErr = 'Minimum 8 characters');
      return false;
    }
  ...
  Future<void> _login() async {
    ...
    final result = await _api.loginWithPassword(
        widget.email, _passwordCtrl.text);
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    _anim(2, _buildPasswordField()),
                    const SizedBox(height: 28),
                    _anim(3, _buildLoginButton()),
                    const SizedBox(height: 16),
  ...
  Widget _buildHeadline() => Padding(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text('Signing in to your secure\npremium workspace.',
          style: TextStyle(
  ...
  // ─────────────────────────────────────────────
  //  Email display chip  (read-only, non-editable)
  // ─────────────────────────────────────────────
  Widget _buildEmailChip() => Padding(
    ...
    child: Container(
      ...
      child: Row(children: [
        Icon(Icons.mail_outline_rounded, color: _C.w35, size: 15),
      ...
      child: Container(
        ...
        child: Center(
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.sms_outlined, color: _C.w35, size: 14),
  ...
  Widget _buildFooter() => Container(
    ...
    child: Column(children: [
      ...
      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text('Your connection is secure and encrypted.',
            style: TextStyle(
